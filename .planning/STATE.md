...
**Current focus:** Phase 1 — Foundation Close-out
...
- Phase order follows docs/22 spine (board proof before full room lifecycle)
- P1 phases (6–8) gated on P0 acceptance in 1 teacher + 2 student tabs
